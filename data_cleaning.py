...
class DataCleaning:
    ...
    '''
    # ! ADDITIONAL function to remove symbols from phone numbers as initial clearning step for USER DATA !
    ...
    def clean_user_data(self, dataframe):
        ...
        for index in dataframe.index:
            if dataframe['first_name'][index].isalpha() == False and \
                ...
                errors_first_name+=1
        #print("Errors in first names:", errors_first_name) # ZERO ERRORS FOUND
        errors_last_name = 0
        for index in dataframe.index:
            if dataframe['last_name'][index].isalpha() == False and \
                ...
                errors_first_name+=1
        #print("Errors in last names:", errors_last_name) # ZERO ERRORS FOUND
        ...
        for index in dataframe.index:
            if not re.fullmatch(uuid_regex, dataframe['user_uuid'][index]):
                ...
                count_uuid+=1
        #print("Errors in user_uuid:", count_uuid) #NO ERRORS FOUND
    ...
    def clean_store_data(self, stores_dataframe):
        ...
        for index in stores_dataframe.index:
            if 'ee' in stores_dataframe['continent'][index]:
                #print(stores_dataframe['continent'][index])
